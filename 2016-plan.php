...
Fall 2016 - Spring 2018</h2>
    ...
    <p>Action items listed below have been completed, and four items have been carried forward to the <a href="index.php">Summer 2018 - Spring 2021 Anti-Violence Plan.</a></p>
</div>
...
<div class="plan-section__container">
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> Task group recommendation is due in June 2018 </li>
                <li><strong>Spring 2018:</strong> New web-based prevention program by EverFi which includes primary prevention content for faculty and staff was implemented </li>
     ...
     <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> Partners from high schools and youth organizations in Iowa City, Cedar Rapids, and surrounding areas attended training and networking sessions as part of the What About Me(n)? Summit</li>
                <li><strong>Spring 2018:</strong> The 2018-2021 Anti-Violence Plan includes a strategy to host K-12 education and community leaders in discussions of sexual misconduct policies critical to prevention, intervention, and legislation</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> RVAP created a paid student internship position to expand partnerships with Iowa City community organizations for offering Raise the Bar workshops</li>
...
<p>Explore options and models for partnering with feeder high schools given evidence that prevention is more likely to be effective with students, developmentally, before college (2) (<a href="#SourceC">C</a>)</p>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> The 2018-2021 Anti-Violence Plan continues to prioritize partnering with Fraternity &amp; Sorority Life to engage in alcohol harm reduction efforts</li>
                <li><strong>Fall 2017:</strong> Fraternity and Sorority Life student leaders created a <a href="https://www.youtube.com/watch?v=uLgueX9uAaA&feature=youtu.be">Not In Our Community"</a> video against sexual assault</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> <a href="#">The 2018-2021</a> Anti-Violence Plan continues to prioritize prevention and education meeting the needs of racial and ethnic minority students, students with disabilities, international students, and LGBTQ communities on campus</li>
                <li><strong>Spring 2018:</strong> The Iowa Intensive English Program piloted an open house to introduce incoming ESL students to campus and community resources</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> This strategy was carried over to the <a href="#">2018-2021 Anti-Violence Plan</a>. An additional strategy to involve parents in prevention discussions is also included in the new plan.</li>
            </ul>
        </div>
    </div>
    <div class="plan-table">
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
               <li><strong>Spring 2018:</strong> Over 80 students, staff, faculty, and community members attended the What About Me(n)? Summit, an event focused on engaging those identifying as male and those leading and mentoring male-identified youth in violence prevention</li>
               <li><strong>Spring 2018:</strong> The 2018-2021 Anti-Violence Plan continues to prioritize mobilizing and engaging male-identified students, staff, faculty, and community partners</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> The 2018-2021 Anti-Violence Plan continues to prioritize messaging campaigns for raising awareness about sexual misconduct, dating/domestic violence, and stalking</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> Three sections of Flip the Script were offered in the 2017-2018 academic year</li>
                <li><strong>Spring 2018:</strong> Enrollment opened for two sections of Flip the Script in the fall 2018 semester</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> DPS implemented a <a href="https://now.uiowa.edu/2018/03/ui-department-public-safety-rolls-out-improved-nite-ride-service">new ride-request NITE RIDE application</a> for campus members to schedule a safe ride home during the evening and early morning hours</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> The 2018-2021 Anti-Violence Plan continues to prioritize collaborating on alcohol harm reduction efforts on campus and in the community
                </li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong><a href="#">The 2018-2021 Anti-Violence Plan</a> includes a strategy to expand the Certified Peer Educator program to enhance culturally specific representation and content</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> The 2018-2021 Anti-Violence Plan includes a strategy to update the Education and Training Database to collect attendance data for individual student participants</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> The Campus Education Subcommittee published <a href="https://endingviolence.uiowa.edu/assets/Uploads/CES-Gender-Based-Violence-Prevention-Learning-Outcomes.pdf">Gender-Based Violence Prevention Learning Outcomes</a> that describe goals for every student to develop the knowledge and skills to engage in healthy relationships, serve as active bystanders, respond effectively to disclosures, and report problems</li>
     ...
     <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> Results from the second Speak Out Iowa survey influenced the strategies in the <a href="#">2018-2021 Anti-Violence Plan</a></li>
                <li><strong>Fall 2017:</strong> The second Speak Out Iowa survey went live October 24, 2017</li>
                <li><strong>Spring 2017:</strong> Campus Climate Survey Subcommittee is preparing for a second <a href="https://speakout.uiowa.edu/">Speak Out Iowa</a> survey to be implemented in fall 2017</li>
            </ul>
        </div>
    </div>   
</div>
...
<div class="plan-table">
        ...
        <div class="plan-table__column">
             <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> The 2018-2021 Anti-Violence Plan continues to prioritize increasing knowledge of how to get help and where to report</li>
                <li><strong>Spring 2018:</strong> The University of Iowa Clery compliance team collaborated with other Big 10 institutions to align procedures for the use of Crime Alerts with reports related to non-stranger sexual assault</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> The <a href="#">2018-2021 Anti-Violence Plan</a> continues to prioritize increasing knowledge of how to get help and where to report through training students, faculty, and staff</li>
                <li><strong>Spring 2018:</strong> The newly implemented web-based prevention program for faculty and staff by EverFi includes modules on responding to disclosures for those in supervisory positions</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
             <h5>Updates</h5>
                    ...
                    <ul class="plan-table__timely-updates">
                        <li><strong>Spring 2018:</strong> This strategy was carried over to the <a href="#">2018-2021 Anti-Violence Plan</a></li>
     ...
     <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> Anti-Violence Coalition in-service training on the “#MeToo” movement in higher education was made available to AVC members and others involved in the campus Title IX complaint process</li>
                <li><strong>Spring 2018:</strong> The 2018-2021 Anti-Violence Plan includes a strategy to develop coordinated learning outcomes for training for campus decision makers and judicial administrators</li>

                <li><strong>Spring 2018:</strong> 1-hour training on trauma-informed response to sexual assault, dating/domestic violence, and stalking was provided to all DPS officers</li>
    ...
    <div class="plan-table">
        <div class="plan-table__column plan-table__column--large-text">
            ...
            <ul>
                ...
                <li>Increase survivors' access to immediate support through RVAP advocacy and mobile messaging<br />
                    <strong>Spring 2018:</strong> This strategy was not completed when state budget cuts to funding the Iowa Sexual Abuse Hotline required a shift in focus towards maintaining current levels of service</li>
        ...
        <div class="plan-table__column">
             <h5>Updates</h5>
                    <ul class="plan-table__timely-updates">
                        <li><strong>Spring 2018:</strong> Commitment made to maintain RVAP campus advocate position</li>
                        <li><strong>Spring 2018:</strong> <a href="#">The 2018-2021 Anti-Violence Plan</a> includes strategies to expand collaboration to promote trauma-informed approaches</li>
...
<p>Expand resources for people accused of sexual misconduct by:</p>
        ...
        <div class="plan-table__column">
             <h5>Updates</h5>
                    <ul class="plan-table__timely-updates">
                        <li><strong>Spring 2018:</strong> OSMRC began offering student judicial process guidance for student respondents involved in a university investigation</li>
                        <li><strong>Spring 2018:</strong> This strategy was carried over to the 2018-2021 Anti-Violence Plan</li>
                    </ul>
        </div>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
             <h5>Updates</h5>
                    <ul class="plan-table__timely-updates">
                        <li><strong>Spring 2018:</strong> An assessment protocol was established for the UI-CERB program and all facilitators were trained in implementation of program assessment</li>
                        <li><strong>Spring 2018:</strong> Four new UI-CERB facilitators began training, scheduled to be completed in summer 2018</li>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
             <h5>Updates</h5>
                    <ul class="plan-table__timely-updates">
                        <li>Spring 2018: This strategy was carried over to the <a href="#">2018-2021 Anti-Violence Plan</a></li>
                    </ul>
        </div>
...
<div class="plan-section__container">
  ...
  <div class="plan-table">
        ...
        <div class="plan-table__column">
             <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> This strategy was explored but not completed due to changes in senior leadership, the anticipation of new rules and changes to current federal guidance from the Department of Education, and workload related to other priorities in the plan. The <a href="#">2018-2021 Anti-Violence Plan</a> includes a strategy that identifies specific areas of focus for alignment between policies. </li>
            </ul>
        </div>
    ...
    <div class="plan-table">
        ...
        <div class="plan-table__column">
            <h5>Updates</h5>
            <ul class="plan-table__timely-updates">
                <li><strong>Spring 2018:</strong> The 2018-2021 Anti-Violence Plan includes a strategy to work with the Student Advisory Committee on Sexual Misconduct and other partners to continue collecting campus feedback to inform policy review and revision</li>
    ...
    <div class="plan-table">
     ...
     <div class="plan-table">
        ...
        <div class="plan-table__column">
             <h5>Updates</h5>
                    <ul class="plan-table__timely-updates">
                        <li><strong>Spring 2018:</strong> The 2018-2021 Anti-Violence Plan continues to prioritize policy education</li>
                        <li><strong>Spring 2018:</strong> OSMRC began reviewing case data in preparation for publishing a 2017 annual report</li>
...
<div class="plan-section__container">
    <div class="plan-section" id="sources">
        <h3 class="plan-section__header">Sources</h3>
        <p><a name="SourceA" id="SourceA"></a>A - ATIXA: Association of Title IX Administrators (n.d.). The ATIXA one policy, one process model policy: Why choose the-one policy/one-process model. Retrieved from <a href="https://atixa.org/wordpress/wp-content/uploads/2013/05/Why-Choose-the-One-Policy-One-Process-Model.pdf">https://atixa.org/wordpress/wp-content/uploads/2013/05/Why-Choose-the-One-Policy-One-Process-Model.pdf</a> </p>
        <p><a name="SourceB" id="SourceB"></a>B - ATIXA: Association of Title IX Administrators (2016). The ATIXA Title IX and VAWA section 304 training checklist. Retrieved from <a href="https://atixa.org/resources/training-checklist/">https://atixa.org/resources/training-checklist/</a></p>
        <p><a name="SourceC" id="SourceC"></a>C - Centers for Disease Control. (2016). STOP SV: A technical package to prevent sexual violence. Atlanta, GA. Retrieved from <a href="https://www.cdc.gov/violenceprevention/pdf/sv-prevention-technical-package.pdf">https://www.cdc.gov/violenceprevention/pdf/sv-prevention-technical-package.pdf  </a></p>
        <p><a name="SourceD" id="SourceD"></a>D - The University of Iowa Academic Support and Retention (n.d.). Excelling@Iowa data showing that 20% of students talk to their parents and families every 3 waking hours. Shared at meeting 9/2016.</p>
        <p><a name="SourceE" id="SourceE"></a>E - Nation, M., Crusto, C., Wandersman, B., Kumpfer, K. L., Seybolt, D., Morrissey-Kane, E., &amp; Davino, K. (2003). What works in prevention: Principles of effective prevention programs. American Psychologist, 58(6/7), 449-456.</p>
        <p><a name="SourceF" id="SourceF"></a>F - Nation, M., Keener, D., Wandersman, A., &amp; DuBois, D. (2005). Applying the principles of prevention: What do prevention practitioners need to know about what works? Retrieved from <a href="http://www.odvn.org/training/Documents/doc-principles-prevention.pdf">http://www.odvn.org/training/Documents/doc-principles-prevention.pdf</a></p>
        <p><a name="SourceG" id="SourceG"></a>G - Office of Civil Rights. (April 4, 2011). Dear colleague letter on sexual violence. Retrieved from <a href="http://www2.ed.gov/about/offices/list/ocr/letters/colleague-201104.pdf">http://www2.ed.gov/about/offices/list/ocr/letters/colleague-201104.pdf</a></p>
        <p><a name="SourceH" id="SourceH"></a>H - U.S. Department of Justice Office on Violence Against Women 2014 Grant to Resource Sexual Assault, Domestic Violence, Dating Violence, and Stalking on Campus</p>
        <p><a name="SourceI" id="SourceI"></a>I - The White House (2014).The first report of the White House Task Force to Protect Students From Sexual Assault. Washington, DC: Author. Retrieved from <a href="https://www.notalone.gov/assets/report.pdf">https://www.notalone.gov/assets/report.pdf</a></p>
        <p><a name="SourceJ" id="SourceJ"></a>J - The White House Task Force to Protect Students from Sexual Assault (n.d.). Building partnerships among law enforcement agencies, colleges and universities: Developing a memorandum of understanding to prevent and respond effectively to sexual assaults at colleges in universities. Retrieved from <a href="https://www.whitehouse.gov/sites/default/files/docs/white_house_task_force_law_enforcement_mou.pdf">https://www.whitehouse.gov/sites/default/files/docs/white_house_task_force_law_enforcement_mou.pdf</a></p>
        <p> </p>
        <p>Download a PDF of this document here: <span class="file"><img class="file-icon" alt="PDF icon" title="application/pdf" src="https://osmrc.uiowa.edu/modules/file/icons/application-pdf.png" /><a href="https://osmrc.uiowa.edu/sites/osmrc.uiowa.edu/files/wysiwyg_uploads/UI%20Anti-Violence%20Plan_FULL_1.pdf" type="application/pdf; length=111685">UI Anti-Violence Plan_FULL.pdf</a></span></p>
    </div>
</div>
<p>&nbsp;</p>
